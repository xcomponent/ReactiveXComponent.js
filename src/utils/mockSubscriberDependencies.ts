...
let correctSnapshotRequest =
    correctDataToSendSnapshot.topic +
    ' ' +
    correctDataToSendSnapshot.componentCode +
    ' ' +
    JSON.stringify(correctDataToSendSnapshot.data);

let snapshotResponseData = {
    Header: {
        EventCode: 0,
        Probes: [],
        IsContainsHashCode: false,
        IncomingEventType: 0,
        MessageType: 'XComponent.Common.Processing.SnapshotResponse'
    },
    JsonMessage: '{"Items":"H4sIAAAAAAAEAItmiGUAAKZ0XTIEAAAA"}'
};
let getModelResponseData = {
    ModelFound: true,
    ApiName: 'xcApi',
    ModelContent: {
...
let getModelResponseUndefined =
    ...
    JSON.stringify({
        ...
        ModelContent: {
            ...
            Components: [{ Name: 'HelloWorld', Graphical: undefined, Model: undefined }]
        }
    });
