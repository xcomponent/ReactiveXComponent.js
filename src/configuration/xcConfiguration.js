...
<deployment environment="Dev" xcProjectName="HelloWorld" deploymentTargetCode="-487384339" deploymentTargetName="HelloWorldApi" version="1.0" frameworkType="Framework4" xmlns="http://xcomponent.com/DeploymentConfig.xsd">
  ...
  <clientAPICommunication>
    <publish componentCode="-69981087" stateMachineCode="-829536631" eventType="UPDATE" topicType="output" communicationType="WEB_SOCKET" stateCode="0" eventCode="10" event="XComponent.HelloWorld.UserObject.SayHello" communication="websocket">
      <topic type="STATIC">input.1_0.HelloWorldMicroservice.HelloWorld.HelloWorldManager</topic>
    </publish>
    <publish componentCode="-69981087" stateMachineCode="-343862282" eventType="UPDATE" topicType="output" communicationType="WEB_SOCKET" stateCode="1" eventCode="10" event="XComponent.HelloWorld.UserObject.SayHello" communication="websocket">
      <topic type="STATIC">input.1_0.HelloWorldMicroservice.HelloWorld.HelloWorldResponse</topic>
    </publish>
    <publish componentCode="-69981087" stateMachineCode="-343862282" eventType="UPDATE" topicType="output" communicationType="WEB_SOCKET" stateCode="1" eventCode="9" event="XComponent.HelloWorld.UserObject.SayGoodBye" communication="websocket">
      <topic type="STATIC">input.1_0.HelloWorldMicroservice.HelloWorld.HelloWorldResponse</topic>
    </publish>
    <publish componentCode="-69981087" stateMachineCode="-343862282" eventType="UPDATE" topicType="output" communicationType="WEB_SOCKET" stateCode="0" eventCode="9" event="XComponent.HelloWorld.UserObject.SayGoodBye" communication="websocket">
      <topic type="STATIC">input.1_0.HelloWorldMicroservice.HelloWorld.HelloWorldResponse</topic>
    </publish>
    ...
    <components>
      <component name="HelloWorld" id="-69981087">
        <events>
          ...
          <event name="XComponent.HelloWorld.UserObject.SayGoodBye" id="9" />
          <event name="XComponent.HelloWorld.UserObject.SayHello" id="10" />
        </events>
        <stateMachines>
          ...
          <stateMachine name="HelloWorldResponse" id="-343862282">
            <states>
              <State name="LoopHello" id="1" />
              <State name="LoopGoodBye" id="0" />
            </states>
          </stateMachine>
        </stateMachines>
      </component>
